  ...
  return (
    <AppLayout title="Cài đặt">
      <div className="animate-fade-in space-y-6 max-w-2xl">
        <PageHeader title="Cài đặt" description="Cấu hình ứng dụng và quản lý dữ liệu" />
        ...
        <Card className="p-6">
          ...
          <div className="flex gap-4">
            <Card
              className={`flex-1 p-4 cursor-pointer transition-all ${
                isAdmin ? 'border-primary bg-primary/5' : 'hover:border-muted-foreground'
              }`}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Quyền quản trị đầy đủ</p>
                </div>
                {isAdmin && <Badge className="ml-auto">Đang chọn</Badge>}
              </div>
            </Card>
            <Card
              className={`flex-1 p-4 cursor-pointer transition-all ${
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Quyền giới hạn</p>
                </div>
                {!isAdmin && <Badge className="ml-auto">Đang chọn</Badge>}
              </div>
            </Card>
          ...
          <div className="mt-4 p-4 bg-muted/50 rounded-lg">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                • <strong>Admin:</strong> Có thể bán hàng vượt tồn kho (với cảnh báo)
              </li>
              <li>
                • <strong>Nhân viên:</strong> Không thể bán vượt số lượng tồn kho
              </li>
            </ul>
          </div>
        </Card>
