      ...
      <div ref={ref} className="bg-muted/30 border-t">
        <Tabs defaultValue="inventory" className="w-full">
          ...
          <TabsContent value="info" className="p-4 m-0">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">{formatCurrency(product.costPrice)}</span>
              </div>
              <div>
              ...
              {(product as any).serialNumber && (
                <div className="col-span-2">
                  ...
                  <span className="ml-2 font-medium">{(product as any).serialNumber}</span>
                </div>
              )}
            </div>
          </TabsContent>
          ...
          <TabsContent value="notes" className="p-4 m-0">
            <p className="text-sm text-muted-foreground">{product.notes || 'Chưa có ghi chú'}</p>
          </TabsContent>
                ...
                {transactions.length === 0 ? (
                  ...
                  transactions.map((tx) => (
                    <TableRow key={tx.id + tx.date}>
                      ...
                      <TableCell>
                        <Badge variant={tx.type === 'import' ? 'secondary' : 'outline'}>
