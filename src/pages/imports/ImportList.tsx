  ...
  const filteredOrders = useMemo(() => {
    ...
    if (appliedFilters) {
      ...
      if (appliedFilters.dateFrom) {
        ...
        result = result.filter((r) => {
          const orderDate = new Date(r.received_at);
            ...
            <TableHeader>
              <TableRow>
                <TableHead className="w-12">
                  <Checkbox
                    checked={
                      filteredOrders.length > 0 && selectedImports.size === filteredOrders.length
                    }
              ...
              {isLoading ? (
                ...
                filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="font-mono text-primary hover:underline">{order.code}</span>
                    </TableCell>
                    ...
                    <TableCell className="max-w-[200px] truncate">{order.note || '-'}</TableCell>
