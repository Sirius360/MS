    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>Chọn loại giấy và cấu hình nội dung tem mã cần in</DialogDescription>
        </DialogHeader>

        <Tabs
          value={activeTab}
          onValueChange={(v) => setActiveTab(v as 'products' | 'settings')}
                ...
                <div className="space-y-4 p-4 bg-muted/30 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setSettings({ ...settings, labelType: v as LabelSettings['labelType'] })
                      }
                    >
        ...
        <DialogFooter className="flex items-center justify-between sm:justify-between border-t pt-4 mt-4">
          <div className="flex items-center gap-4">
            ...
            {selectedTemplateData && (
              <span className="text-sm text-muted-foreground">
                Mẫu:{' '}
                <span className="font-medium text-foreground">{selectedTemplateData.name}</span>
              </span>
            )}
          </div>
