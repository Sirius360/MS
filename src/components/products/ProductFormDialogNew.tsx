                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <span className="inline-block w-3 h-3 rounded bg-primary/20 text-primary text-[10px] flex items-center justify-center">
                                  %
                                </span>
                                Thiết lập giá
                              </Button>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handleSalePriceBeforeTaxChange(Number(e.target.value))
                              }
                              className="mt-1"
                              placeholder="0"
                            />
                          ...
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={handleVatSaleChange}
                            >
                              <SelectTrigger className="mt-1">
                                <SelectValue />
                              </SelectTrigger>
                      ...
                      <CollapsibleTrigger className="w-full px-4 py-3 flex items-center justify-between hover:bg-muted/50">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-0.5">
                            Quản lý số lượng tồn kho và định mức tồn. Khi tồn kho chạm đến định mức,
