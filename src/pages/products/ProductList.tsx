...
import { Plus, Filter, Search, Star, ChevronLeft, ChevronRight, X } from 'lucide-react';
import { Label } from '@/components/ui/label';
import { useProducts } from '@/hooks/useBackendApi';
import { useProductGroups } from '@/hooks/useBackendApi';
              ...
              {isLoading ? (
                ...
                paginatedProducts.map((product) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="font-mono text-primary hover:underline">{product.code}</span>
                    </TableCell>
                    <TableCell className="font-medium">{product.name}</TableCell>
                    <TableCell>{getCategoryName(product.groupId || null)}</TableCell>
                    <TableCell className="text-right">
                      {formatCurrency(product.salePrice || product.sale_price_default || 0)}
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {(product.stockQty || product.stock_qty || 0) <= 0 && (
