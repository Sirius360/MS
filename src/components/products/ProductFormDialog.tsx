    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{isEditing ? 'Chỉnh sửa hàng hóa' : 'Tạo hàng hóa mới'}</DialogTitle>
            <DialogDescription>Điền thông tin chi tiết cho hàng hóa</DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => onFormChange({ salePrice: Number(e.target.value) })}
                />
              </div>
              <div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: 'in_stock' | 'out_of_stock' | 'discontinued') =>
            ...
            {Object.keys(formData.config).length > 0 && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={onAddConfigKey}>
          ...
          <DialogFooter>
            ...
            <Button onClick={onSave}>{isEditing ? 'Cập nhật' : 'Tạo mới'}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    );
